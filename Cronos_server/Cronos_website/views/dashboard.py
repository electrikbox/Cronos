...
def render_dashboard_page(request: WSGIRequest, header: dict, access_token) -> HttpResponse:
    ...
    # If classic load, set initial values
    ...
    # After form error, set initial values from cookies
    else:
        set_initial = {
    ...
    crons = crons.json()
    paginator = Paginator(crons, 7)  # 7 crons max per page
    page_number = request.GET.get("page")  # Get the page number
    page_obj = paginator.get_page(page_number)  # Get the page crons
...
# TOOLS - Create a new cron job and render the dashboard
# ==============================================================================
...
# TOOLS - Get the command from form data
# ==============================================================================
...
# TOOLS - Handle an invalid form submission
# ==============================================================================
